...
class n_way_fifo_cache(cache_base):
    ...
    def write_registers(self):
        ...
        if self.data_hazard:
            self.vf.write("  // When the next fetch is in the same set, tag array and data array might be old (data hazard).\n")
    ...
    def write_memory_controller_block(self):
        ...
        self.vf.write("                      data_write_din[var_0 * LINE_WIDTH + offset * WORD_WIDTH + var_1 * 8 + var_8] = din_reg[var_1 * 8 + var_8];\n")
        self.vf.write("                  end\n")
        self.vf.write("                end\n")
        self.vf.write("              end\n")
    ...
    def write_bypass_block(self):
        ...
        self.vf.write("                for (var_9 = 0; var_9 < 8; var_9 = var_9 + 1) begin\n")
        self.vf.write("                  if (wmask_reg[var_6])\n")
        self.vf.write("                    new_data_next[var_5 * LINE_WIDTH + offset * WORD_WIDTH + var_6 * 8 + var_9] = din_reg[var_6 * 8 + var_9];\n")
        self.vf.write("                end\n")
        self.vf.write("              end\n")
        self.vf.write("            end\n")
        self.vf.write("          end\n")
